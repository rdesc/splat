...
| <img src="figures/train_progress1.gif" width="500"> | <img src="figures/train_progress2.gif" width="500"> |
|:---------------------------------------------------:|:---------------------------------------------------:|
...
While this setup was able to generate a reasonable reconstruction of the Duckietown track, the quality of the reconstruction is insufficient when observing from the Duckiebot view.
